...
def figure(dict_plot_parameters):
	...
	#----------------------------------
	if dict_plot_parameters["twinx_axis_source_index_list"] is not None:
		list_sources = dict_plot_parameters["twinx_axis_source_index_list"]
	...
	#----------------------------------
	if dict_plot_parameters["twiny_axis_source_index_list"] is not None:
		list_sources = dict_plot_parameters["twiny_axis_source_index_list"]
		if not MpaTool.is_multidimensional_list_tuple(list_sources):
			list_sources = [list_sources]
	...
	n_rows, n_columns = numpy.shape(list_axis_objects)
	dict_plot_parameters["figure_number_of_rows"] = n_rows
	dict_plot_parameters["figure_number_of_columns"] = n_columns

	return (object_figure, list_axis_objects, dict_plot_parameters)
